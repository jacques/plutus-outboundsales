{include file="../admin__header.tpl" title="Outbound Sales &mdash; Campaigns &mdash; Sales" nav="salestools"}

<h2 class="page-header">Campaigns Sales &mdash; {$campaign->name|escape}</h2>
...
{assign var=user value=$row->user()->first()}
    <tr>
      ...
      <td></td>
      <td><acronym title="South African Rand">ZAR</acronym></td>
      <td></td>
      <td></td>
      <td>
...
{foreachelse}
    <tr>
      <td colspan="10">You presently have no sales associated with this campaign.</td>
    </tr>
{/foreach}
  </tbody>
  <tfoot>
